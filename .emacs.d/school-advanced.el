...
;; Time-stamp: <Sat 2011-03-26 12:30 di-mar_j>
;;
...
(global-set-key [(control j)] 'std-file-header)
...
;; (setq write-file-hooks write-file-hooks)

(setq std-c-alist               '( (cs . "/*") (cc . "** ") (ce . "*/") )
      std-css-alist             '( (cs . "/*") (cc . "** ") (ce . "*/") )
      std-tuarg-alist           '( (cs . "(*") (cc . "** ") (ce . "*)") )
...
(global-set-key [(control c) (control c)] 'std-toggle-comment)
